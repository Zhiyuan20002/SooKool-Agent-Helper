...
const labels: Record<AppLanguage, Record<MarketCategoryKey, string>> = {
  ...
  'zh-HK': { all: '全部', efficiency: '效率工具', qualitySecurity: '質素與安全', designFrontend: '設計與前端', development: '開發工具', contentOffice: '內容與辦公', dataResearch: '資料與研究', communication: '溝通協作', creative: '創意創作', devops: '開發運維', email: '電子郵件', finance: '金融', health: '健康', research: '研究', security: '安全', softwareDevelopment: '軟件開發', webDevelopment: 'Web 開發', machineLearning: '機器學習', blockchain: '區塊鏈', other: '其他' },
