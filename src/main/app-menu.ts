...
import { appDisplayNames } from './app-localization'
...
const labels: Record<AppLanguage, MenuLabels> = {
  ...
  'zh-HK': {
    ...
    about: '關於 SooKool 智能體助手',
    services: '服務',
    hide: '隱藏 SooKool 智能體助手',
    hideOthers: '隱藏其他應用程式',
    showAll: '全部顯示',
    quit: '結束 SooKool 智能體助手',
    file: '檔案',
    local: '技能庫',
    market: '技能市場',
    settings: '設定…',
  ...
  'ja-JP': {
    ...
    about: 'SooKool エージェントアシスタントについて',
    services: 'サービス',
    hide: 'SooKool エージェントアシスタントを隠す',
    hideOthers: 'ほかを隠す',
    showAll: 'すべてを表示',
    quit: 'SooKool エージェントアシスタントを終了',
    file: 'ファイル',
    local: 'スキルライブラリ',
    market: 'スキルマーケット',
    settings: '設定…',
  ...
  'fr-FR': {
    ...
    about: 'À propos de l’Assistant d’agents SooKool',
    services: 'Services',
    hide: 'Masquer l’Assistant d’agents SooKool',
    hideOthers: 'Masquer les autres',
    showAll: 'Tout afficher',
    quit: 'Quitter l’Assistant d’agents SooKool',
    file: 'Fichier',
    local: 'Bibliothèque de compétences',
  ...
  'ko-KR': {
    ...
    about: 'SooKool 에이전트 도우미에 관하여',
    services: '서비스',
    hide: 'SooKool 에이전트 도우미 가리기',
    hideOthers: '기타 가리기',
    showAll: '모두 보기',
    quit: 'SooKool 에이전트 도우미 종료',
    file: '파일',
    local: '스킬 라이브러리',
    market: '스킬 마켓',
    settings: '설정…',
  ...
  'es-ES': {
    ...
    about: 'Acerca del Asistente de agentes SooKool',
    services: 'Servicios',
    hide: 'Ocultar el Asistente de agentes SooKool',
    hideOthers: 'Ocultar otros',
    showAll: 'Mostrar todo',
    quit: 'Salir del Asistente de agentes SooKool',
    file: 'Archivo',
    local: 'Biblioteca de habilidades',
  ...
  'pt-BR': {
    ...
    about: 'Sobre o Assistente de agentes SooKool',
    services: 'Serviços',
    hide: 'Ocultar Assistente de agentes SooKool',
    hideOthers: 'Ocultar outros',
    showAll: 'Mostrar tudo',
    quit: 'Sair do Assistente de agentes SooKool',
    file: 'Arquivo',
    local: 'Biblioteca de habilidades',
    market: 'Mercado de habilidades',
  ...
  ar: {
    ...
    about: 'حول مساعد الوكلاء SooKool',
    services: 'الخدمات',
    hide: 'إخفاء مساعد الوكلاء SooKool',
    hideOthers: 'إخفاء التطبيقات الأخرى',
    showAll: 'إظهار الكل',
    quit: 'إنهاء مساعد الوكلاء SooKool',
    file: 'ملف',
    local: 'مكتبة المهارات',
    market: 'سوق المهارات',
    settings: 'الإعدادات…',
    close: 'إغلاق النافذة',
    edit: 'تحرير',
  ...
  template.push(
    ...
    },
    {
      ...
      submenu: [
        ...
        ...(process.platform === 'darwin'
          ? [{ type: 'separator' as const }, { label: text.showAll, role: 'front' as const }]
